  ...
  return (
    <div className="min-h-[50vh] flex items-center justify-center px-5">
      <div className="text-center max-w-sm">
        <h2 className="font-display text-xl font-bold text-navy-800 mb-2">Page Unavailable</h2>
        <p className="text-slate-400 text-sm mb-6">Something went wrong loading this page.</p>
